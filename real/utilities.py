...
# # Ensure compatibility with older protobuf that expects collections.MutableMapping
...
# Compatibility for old protobuf used by kortex_api
if not hasattr(collections, "MutableMapping"):
    collections.MutableMapping = _MutableMapping
if not hasattr(collections, "MutableSequence"):
    collections.MutableSequence = _MutableSequence
